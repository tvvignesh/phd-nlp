...
# Define a pipeline for feature extraction, vectorization, and SVM classification
pipeline = Pipeline([
    ('vectorizer', DictVectorizer()),
    ('classifier', SVC(kernel='linear', verbose=2))  # Set verbose to 2 for moderate verbosity
])
...
# Tag each example sentence using the trained SVM classifier
for sentence in sentences:
    ...
    # Predict POS tags using the trained SVM classifier
